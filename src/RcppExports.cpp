...
RcppExport SEXP _cppspBART1_cppbart(SEXP x_trainSEXP, SEXP y_trainSEXP, SEXP x_testSEXP, SEXP x_cutSEXP, SEXP n_treeSEXP, SEXP node_min_sizeSEXP, SEXP n_mcmcSEXP, SEXP n_burnSEXP, SEXP tauSEXP, SEXP muSEXP, SEXP tau_muSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP a_tauSEXP, SEXP d_tauSEXP, SEXP stumpSEXP, SEXP no_rotation_boolSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_cppspBART1_cppbart", (DL_FUNC) &_cppspBART1_cppbart, 17},
    {NULL, NULL, 0}
};

RcppExport void R_init_cppspBART1(DllInfo *dll) {
